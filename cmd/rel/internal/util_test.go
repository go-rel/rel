...
func TestGetDatabaseInfo(t *testing.T) {
	t.Run("database", func(t *testing.T) {
		os.Setenv("DATABASE_ADAPTER", "github.com/Fs02/rel/adapter/mysql")
		...
		assert.Equal(t, "github.com/Fs02/rel/adapter/mysql", adapter)
	...
	t.Run("sqlite3", func(t *testing.T) {
		...
		adapter, driver, url := getDatabaseInfo()
		assert.Equal(t, "github.com/Fs02/rel/adapter/sqlite3", adapter)

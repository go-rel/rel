...
func BenchmarkChain3(b *testing.B) {
	var c Condition
	for n := 0; n < b.N; n++ {
		c = Eq("id", 1).AndNe("name", "foo").AndGt("score", 80)
	}
	result = c
}
...
func BenchmarkChain4(b *testing.B) {
	var c Condition
	for n := 0; n < b.N; n++ {
		c = Eq("id", 1).AndNe("name", "foo").AndGt("score", 80).AndLt("avg", 10)
	}
	result = c
}
...
func BenchmarkArray3(b *testing.B) {
	var c Condition
	for n := 0; n < b.N; n++ {
		c = And(Eq("id", 1), Ne("name", "foo"), Gt("score", 80))
	}
	result = c
}
...
func BenchmarkArray4(b *testing.B) {
	var c Condition
	for n := 0; n < b.N; n++ {
		c = And(Eq("id", 1), Ne("name", "foo"), Gt("score", 80), Lt("avg", 10))
	}
	result = c
}
...
// 		Type:  ConditionEq,
// 		Left:  Operand{Column: "field")},
// 		Rght: Operand{Values: []interface{}{"value"}},
// 	}, Eq("field", "value"))
// }
...
// 		Type:  ConditionLt,
// 		Left:  Operand{Column: "field")},
// 		Rght: Operand{Values: []interface{}{10}},
// 	}, Lt("field", 10))
// }
...
// 		Type:  ConditionIn,
// 		Left:  Operand{Column: "field")},
// 		Rght: Operand{Values: []interface{}{"value1", "value2"}},
...
// 		Type:  ConditionLike,
// 		Left:  Operand{Column: "field")},
// 		Rght: Operand{Values: []interface{}{"%expr%"}},
// 	}, Like("field", "%expr%"))
// }
